...
$.extend($.easing, {
    ...
    function() {
        ...
        Panda.$window = $(window), Panda.$body = $(document.body), Panda.status = "", Panda.minDesktopWidth = 992, Panda.isIE = navigator.userAgent.indexOf("Trident") >= 0, Panda.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Panda.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Panda.defaults = {
            ...
            templateCartAddedAlert: '<div class="alert alert-outline alert-btn alert-success alert-inline cart-added-alert" id="cart-added-alert"><a href="cart.html" class="btn btn-success btn-md">View Cart</a><span>"{{name}}" has been added to your cart.</span><button type="button" class="btn btn-link btn-close"><i class="p-icon-times"></i></button></div>',
            zoomImage: {
                responsive: !0,
            ...
            var a = Panda.$(t);
            void 0 === e ? a.append('<div class="loading"><i></i></div>') : "small" == e ? a.append('<div class="loading small"><i></i></div>') : "simple" == e && a.append('<div class="loading small"></div>'), "static" == a.css("position") && Panda.$(t).css("position", "relative")
        }, Panda.endLoading = function(t) {
            Panda.$(t).find(".loading").remove(), Panda.$(t).css("position", "")
        }, Panda.appear = (e = [], a = !1, n = function() {
            for (var a = e.length; a--;) t = e[a], Panda.isOnScreen(t.el, t.options.accX, t.options.accY) && ("function" == typeof $(t.el).data("appear-callback") && $(t.el).data("appear-callback").call(t.el, t.data), t.fn && t.fn.call(t.el, t.data), e.splice(a, 1))
        }, window.addEventListener("scroll", n, {
            passive: !0
        }), window.addEventListener("resize", n, {
            passive: !0
        }), $(window).on("appear.check", n), function(t, i, s) {
            var o = {
                data: void 0,
                accX: 0,
                accY: 0
            };
            s && (s.data && (o.data = s.data), s.accX && (o.accX = s.accX), s.accY && (o.accY = s.accY)), e.push({
                el: t,
                fn: i,
                options: o
            }), a || (a = Panda.requestTimeout(n, 100))
        }), Panda.zoomImageObjects = [], Panda.zoomImage = function(t) {
            $.fn.elevateZoom && t && Panda.$(t).find("img").each((function() {
                var t = $(this);
            ...
            window.addEventListener("resize", (function() {
                Panda.zoomImageObjects.forEach((function(t) {
                    t.each((function() {
                        ...
                        t.closest(".rotate-slider").length > 0 && e ? setTimeout((function() {
                            e.refresh()
                        }), 1200) : e && e.refresh()
                    }))
                }))
            ...
            $.fn.numerator && Panda.$(t).each((function() {
                var t = $(this),
                    e = {
            ...
            $.fn.countdown && Panda.$(t).each((function() {
                var t = $(this),
                    e = t.data("until"),
                    a = t.data("compact"),
            ...
            "object" == typeof noUiSlider && Panda.$(t).each((function() {
                noUiSlider.create(this, $.extend(!0, {
                    start: [6, 30],
                    connect: !0,
                    step: 1,
                    range: {
            ...
            Panda.$(t).find(".lazy-img").each((function() {
            ...
            if ("function" == typeof imagesLoaded && $.fn.isotope) {
                Panda.$(t).each((function() {
                    ...
                    Panda.lazyload(t), t.imagesLoaded((function() {
                        a.customInitHeight && t.height(t.height()), a.customDelay && Panda.call((function() {
                            t.isotope(a)
                        }), parseInt(a.customDelay)), t.isotope(a)
                    }))
                }))
            }
        }, Panda.parallax = function(t, e) {
            $.fn.themePluginParallax && Panda.$(t).each((function() {
                var t = $(this);
                t.themePluginParallax($.extend(!0, Panda.parseOptions(t.attr("data-parallax-options")), e))
            }))
        }, Panda.initFloatingElements = function(t) {
            $.fn.parallax && Panda.$(t).each((function() {
                var t = $(this);
            ...
            if (!Panda.isMobile && "undefined" != typeof skrollr) {
                ...
                e.each((function() {
                    var t = $(this),
                        ...
                        a = [];
                    t.data("options") && (e = t.data("options"), a = Object.keys(e)), "object" == typeof e && (a = Object.keys(e)).length && a.forEach((function(a) {
                        t.attr(a, e[a])
                    }))
                })), e.length && skrollr.init({
                    forceHeight: !1,
                    smoothScrolling: !0
                })
            }
            ...
            var e = Panda.$(t);
            e.find("input").on("focusin", (function(t) {
                e.addClass("show")
            ...
            if (0 != e.length) {
                var a, n, i = !1,
                    ...
                    o = function() {
                        window.innerWidth >= Panda.defaults.stickyHeader.activeScreenWidth && window.pageYOffset >= n ? (e[0].classList.add("fixed"), document.body.classList.add("sticky-header-active")) : (e[0].classList.remove("fixed"), document.body.classList.remove("sticky-header-active"))
                    };
                window.addEventListener("scroll", o, {
                    passive: !0
                }), Panda.$window.on("resize", s), Panda.$window.on("resize", o), Panda.call(s, 500), Panda.call(o, 500)
            }
                ...
                var s = function() {
                        a.each((function(t) {
                            ...
                            if (e.data("is-wrap"))(window.innerWidth < n.minWidth || window.innerWidth >= n.maxWidth) && (e.unwrap(".sticky-content-wrapper"), e.data("is-wrap", !1));
                                ...
                                var a, i = e.removeClass("fixed").outerHeight(!0);
                    ...
                    o = function(t) {
                        t && !t.isTrusted || a.each((function(t) {
                            var e = $(this),
                                a = !0;
                            n.scrollMode && (a = i > window.pageYOffset, i = window.pageYOffset), window.pageYOffset > (0 == n.top ? e.data("top") : n.top) && window.innerWidth >= n.minWidth && window.innerWidth <= n.maxWidth ? (e.hasClass("fix-top") ? (void 0 === e.data("offset-top") && function(t) {
                                var e = 0,
                                    a = 0;
                                $(".sticky-content.fixed.fix-top").each((function() {
                                    e += $(this)[0].offsetHeight, a++
                                })), t.data("offset-top", e), t.data("z-index", n.max_index - a)
                            }(e), e.css("margin-top", e.data("offset-top") + "px")) : e.hasClass("fix-bottom") && (void 0 === e.data("offset-bottom") && function(t) {
                                var e = 0,
                                    a = 0;
                                $(".sticky-content.fixed.fix-bottom").each((function() {
                                    e += $(this)[0].offsetHeight, a++
                                })), t.data("offset-bottom", e), t.data("z-index", n.max_index - a)
                            }(e), e.css("margin-bottom", e.data("offset-bottom") + "px")), e.css("z-index", e.data("z-index")), n.scrollMode ? a && e.hasClass("fix-top") || !a && e.hasClass("fix-bottom") ? (e.addClass("fixed"), e.closest(".page-wrapper").find(".header").hasClass(".header-transparent") && (Panda.$body.hasClass("sidebar-active") || Panda.$body.hasClass("top-sidebar-active") || Panda.$body.hasClass("right-sidebar-active") ? e.closest(".main").css("z-index", "unset") : e.closest(".main").css("z-index", "19"))) : (e.removeClass("fixed"), e.css("margin", ""), e.closest(".page-wrapper").find(".header").hasClass(".header-transparent") && (Panda.$body.hasClass("sidebar-active") || Panda.$body.hasClass("top-sidebar-active") || Panda.$body.hasClass("right-sidebar-active") ? e.closest(".main").css("z-index", "unset") : e.closest(".main").css("z-index", "19"))) : e.addClass("fixed"), n.hide && e.parent(".sticky-content-wrapper").css("display", "")) : (e.removeClass("fixed"), e.css("margin-top", ""), e.css("margin-bottom", ""), n.hide && e.parent(".sticky-content-wrapper").css("display", "none"))
                        }))
                    },
                    r = function(t) {
                        a.removeData("offset-top").removeData("offset-bottom").removeClass("fixed").css("margin", "").css("z-index", ""), Panda.call((function() {
                            s(), o()
                        }))
                    };
                setTimeout(s, 550), setTimeout(o, 600), Panda.call((function() {
                    window.addEventListener("scroll", o, {
                        passive: !0
            ...
            Panda.$body.on("click", t + " .btn-close", (function(e) {
                $(this).closest(t).fadeOut((function() {
                    $(this).remove()
                }))
            }))
            ...
            Panda.$body.on("click", t, (function(t) {
                ...
                t.preventDefault(), 0 === i.find(".collapsing").length && 0 === i.find(".expanding").length && (n.hasClass("expanded") ? i.hasClass("radio-type") || e(n) : n.hasClass("collapsed") && (i.find(".expanded").length > 0 ? Panda.isIE ? e(i.find(".expanded"), (function() {
                    e(n)
                })) : (e(i.find(".expanded")), e(n)) : e(n)))
            }));
            var e = function(e, a) {
                var n = e.closest(".card").find(t);
                e.hasClass("expanded") ? (n.removeClass("collapse").addClass("expand"), e.addClass("collapsing").slideUp(300, (function() {
                    e.removeClass("expanded collapsing").addClass("collapsed"), a && a()
                }))) : e.hasClass("collapsed") && (n.removeClass("expand").addClass("collapse"), e.addClass("expanding").slideDown(300, (function() {
                    e.removeClass("collapsed expanding").addClass("expanded"), a && a()
                })))
            }
        }, Panda.initTab = function(t) {
            Panda.$body.on("click", ".tab .nav-link:not(.no-tab-item)", (function(t) {
                var e = $(this);
                ...
                t.preventDefault(), a.siblings().removeClass("active in"), a.addClass("active in"), n.find(".nav-link").removeClass("active"), n.find('[href="' + e + '"]').addClass("active"), $("html").animate({
            ...
            $.fn.themeSticky && Panda.$(t).each((function() {
                var t = $(this);
            ...
            for (var e = Panda.byClass("ratings-full", t || document.body), a = e.length, n = function() {
                    var t = parseInt(this.firstElementChild.style.width.slice(0, -1)) / 20;
                    this.lastElementChild.innerText = t ? t.toFixed(2) : t
                }, i = 0; i < a; ++i) e[i].addEventListener("mouseover", n, {
                passive: !0
            }), e[i].addEventListener("touchstart", n, {
                passive: !0
            })
            ...
            a.isOpen && a.content ? (a.close(), setTimeout((function() {
                $.magnificPopup.open(n)
            }), 500)) : $.magnificPopup.open(n)
        }, Panda.initPopups = function() {
            Panda.$body.on("click", ".single-product a.submit-review-toggle", (function(t) {
                t.preventDefault(), Panda.popup({
                    items: {
                ...
                t.preventDefault(), Panda.popup({
                    items: {
                        src: '<video src="' + $(t.currentTarget).attr("href") + '" autoplay loop controls>',
                        type: "inline"
                    },
                    mainClass: "mfp-video-popup"
                }, "video")
            })), $(".home > #newsletter-popup").length > 0 && "true" !== Panda.getCookie("hideNewsletterPopup") && setTimeout((function() {
                Panda.popup({
                    items: {
            ...
            setInterval((function() {
                Panda.Minipopup.open({
                    ...
                    imageSrc: "images/products/facebook.png",
                    isPurchased: !0
                }, (function(t) {
            ...
            if (t) {
                ...
                Panda.call(e, 500), window.addEventListener("scroll", e, {
                    passive: !0
                })
            }
            ...
            var a = 0,
                n = void 0 === e ? 600 : e;
            a = "number" == typeof t ? t : Panda.$(t).offset().top, $("html,body").stop().animate({
                scrollTop: a
            }, n)
            ...
            var i, s, o = new Object;
            return o.val = n((function r(d) {
            ...
            build: function() {
                try {
                    var t = window.location.hash,
                        e = $(t);
                    return e.length && "#review_form" != t && "#reviews" != t && -1 == t.indexOf("#comment-") && $("html, body").delay(600).stop().animate({
                        scrollTop: e.offset().top
                    }, 600, "easeOutQuad"), this
                } catch (t) {
                    return this
                }
            },
            getTarget: function(t) {
                ...
                if (0 == t.indexOf("#")) e = $(t);
                    ...
                    var a = window.location.href; - 1 != (a = a.substring(a.indexOf("://") + 3)).indexOf("#") && (a = a.substring(0, a.indexOf("#"))), 0 == (t = (t = t.substring(t.indexOf("://") + 3)).substring(t.indexOf(a) + a.length)).indexOf("#") && (e = $(t))
                }
                return e
            },
            events: function() {
                ...
                return $("body").on("click", 'a[href*="#"].hash-scroll', (function(e) {
                    e.preventDefault();
                    var a = $(this),
                        n = a.attr("href"),
                        i = t.getTarget(n);
            ...
            var t = window.innerWidth < Panda.minDesktopWidth,
                e = function() {
                    window.innerWidth < Panda.minDesktopWidth && !t ? (this.$sidebar.find(".sidebar-content, .filter-clean").removeAttr("style"), this.$sidebar.find(".sidebar-content").attr("style", ""), this.$sidebar.siblings(".toolbox").children(":not(:first-child)").removeAttr("style")) : window.innerWidth >= Panda.minDesktopWidth && !this.$sidebar.hasClass("closed") && t && (this.$sidebar.addClass("closed"), this.$sidebar.find(".sidebar-content").css("display", "none")), t = window.innerWidth < Panda.minDesktopWidth
                };
            ...
            return a.prototype.init = function(t) {
                    var a = this;
                    return a.name = t, a.$sidebar = $("." + t), a.isNavigation = !1, a.$sidebar.length && (a.isNavigation = a.$sidebar.hasClass("sidebar-fixed") && a.$sidebar.parent().hasClass("toolbox-wrap"), a.isNavigation && (e = e.bind(this), Panda.$window.on("resize", e)), Panda.$body.find(".header").hasClass("header-transparent") && Panda.$body.find(".main").css("z-index", "19"), Panda.$window.on("resize", (function() {
                        Panda.$body.removeClass(t + "-active"), Panda.$body.find(".header").hasClass("header-transparent") && setTimeout((function() {
                            Panda.$body.find(".main").css("z-index", "19")
                        }), 400)
                    })), a.$sidebar.find(".sidebar-toggle").add("sidebar" === t ? ".left-sidebar-toggle" : "." + t + "-toggle").on("click", (function(t) {
                        a.toggle(), $(this).blur(), $(".sticky-sidebar").trigger("recalc.pin.left", [400]), Panda.$body.find(".header").hasClass("header-transparent") && $(window).innerWidth() < 992 && Panda.$body.find(".main").css("z-index", "unset"), t.preventDefault()
                    })), a.$sidebar.find(".sidebar-overlay, .sidebar-close").on("click", (function(e) {
                        Panda.$body.removeClass(t + "-active"), Panda.$body.find(".header").hasClass("header-transparent") && setTimeout((function() {
                            Panda.$body.find(".main").css("z-index", "19")
                        }), 400), $(".sticky-sidebar").trigger("recalc.pin.left", [400]), e.preventDefault()
                    })), setTimeout((function() {
                    ...
                    if (window.innerWidth >= Panda.minDesktopWidth && t.$sidebar.hasClass("sidebar-fixed")) {
                        ...
                        t.isNavigation && (e || t.$sidebar.find(".filter-clean").hide(), t.$sidebar.siblings(".toolbox").children(":not(:first-child)").fadeToggle("fast"), t.$sidebar.find(".sidebar-content").stop().animate({
                            height: "toggle",
                            "margin-bottom": e ? "toggle" : -6
                        }, (function() {
                            $(this).css("margin-bottom", ""), e && t.$sidebar.find(".filter-clean").fadeIn("fast")
                        }))), t.$sidebar.toggleClass("closed")
                    } else t.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)), Panda.$body.toggleClass(t.name + "-active").removeClass("closed"), window.innerWidth >= 1200 && Panda.$body.hasClass("with-flex-container") && $(".owl-carousel").trigger("refresh.owl.carousel")
                },
                function(t) {
                    return new a(t)
                }
            ...
            return t.prototype.init = function(t) {
                    ...
                    s.$wrapper = t, s.isQuickview = !!t.closest(".mfp-content").length, s._isPgvertical = !1, s.isQuickview && (i = i.bind(this), Panda.ratingTooltip()), o.on("initialized.owl.carousel", (function(t) {
                            document.body.classList.contains("home") || s.isQuickview || o.append('<a href="#" class="product-image-full"><i class="p-icon-zoom"></i></a>'),
                                function(t) {
                                    t.$thumbs = t.$wrapper.find(".product-thumbs"), t.$thumbsWrap = t.$thumbs.closest(".product-thumbs-wrap"), t.$thumbUp = t.$thumbsWrap.find(".thumb-up"), t.$thumbDown = t.$thumbsWrap.find(".thumb-down"), t.$thumbsDots = t.$thumbs.children(), t.thumbsCount = t.$thumbsDots.length, t.$productThumb = t.$thumbsDots.eq(0), t._isPgvertical = t.$thumbsWrap.parent().hasClass("pg-vertical"), t.thumbsIsVertical = t._isPgvertical && window.innerWidth >= Panda.minDesktopWidth, t.$thumbDown.on("click", (function(a) {
                                    ...
                                    })), n(t), Panda.$window.on("resize", (function() {
                                        n(t)
                                    }))
                                }(s)
                        ...
                        function(t) {
                            t.$selects = t.$wrapper.find(".product-variations select"), t.$items = t.$wrapper.find(".product-variations"), t.$priceWrap = t.$wrapper.find(".product-variation-price"), t.$clean = t.$wrapper.find(".product-variation-clean"), t.$btnCart = t.$wrapper.find(".btn-cart"), t.variationCheck(), t.$selects.on("change", (function(e) {
                                t.variationCheck()
                        ...
                        function(t) {
                            t.$wrapper.on("click", ".btn-cart", (function(e) {
                                ...
                                (a.closest(".product-popup").length || document.body.classList.contains("home")) && Panda.Minipopup.open({
                        ...
                        function(t) {
                            t.$wrapper.on("click", ".btn-compare:not(.open)", (function(e) {
                                ...
                                }), $(this).addClass("open"), $(this).html('<i class="p-icon-check-solid"></i> BROWSE COMPARE'), $(this).attr("title", "Browse compare"), $(this).attr("href", "compare.html")
                            }))
                        }(this)
                    ...
                    if (e.$thumbsDots.filter(".active").removeClass("active"), a.addClass("active"), e.thumbsIsVertical) {
                        ...
                        n < 0 ? e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) - n) : (n = e.$thumbs.offset().top + e.$thumbs[0].offsetHeight - a.offset().top - a[0].offsetHeight) < 0 && e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) + n)
            ...
            function t(t) {
                ...
                $(".cart-added-alert").remove(), $(Panda.parseTemplate(Panda.defaults.templateCartAddedAlert, {
                    name: e.find("h1.product-name").text()
                })).insertBefore(e).fadeIn(), $(this).closest(".product-form-group").length > 0 && $("html, body").animate({
                    scrollTop: 0
                }, 600), $(".sticky-sidebar ").trigger("recalc.pin"), t.preventDefault()
            }

            function e(t) {
                var e = $(t.currentTarget).closest(".product-single");
                "disabled" != e.find(".btn-product.btn-cart").attr("disabled") && Panda.Minipopup.open({
                    message: "Successfully Added",
                    productClass: "product-mini",
                    name: e.find("h1.product-name").text(),
            ...
            function a(t) {
                t.preventDefault();
                var e, a = $(t.currentTarget).closest(".product-single");
                if ((e = a.find(".product-single-carousel").length ? a.find(".product-single-carousel .owl-item:not(.cloned) img") : a.find(".product-gallery-carousel").length ? a.find(".product-gallery-carousel .owl-item:not(.cloned) img") : a.find(".product-gallery img")).length) {
            ...
            function n(t) {
                ...
                e.hasClass("added") || (t.preventDefault(), e.addClass("load-more-overlay loading"), setTimeout((function() {
            ...
            function i(t) {
                t.preventDefault();
                var e = $(t.currentTarget),
                    a = e.parent().children("img").map((function() {
                        return {
            ...
            return function() {
                ...
                return Panda.$body.on("click", ".product-single .btn-wishlist", n), s.length ? document.body.classList.contains("home") ? (s.each((function() {
                    Panda.initProductSingle($(this))
                })), Panda.zoomImage(".product-gallery.row"), null) : null === Panda.initProductSingle(s) ? null : (Panda.$body.on("click", ".product-single .product-image-full", a), Panda.$body.on("click", ".single-product .btn-cart:not(.disabled)", t), Panda.$body.on("click", ".single-product .btn-compare:not(.open)", e), Panda.zoomImage(".product-gallery.row"), Panda.$body.on("click", ".btn-img", i), Panda.$body.on("click", ".rating-form .rating-stars > a", (function(t) {
                    var e = $(this);
            ...
            var e = function(t) {
                    var e, a = ["", "-xs", "-sm", "-md", "-lg", "-xl", "-xxl"];
                    for (this.classList.remove("row"), s = 0; s < 7; ++s)
                        for (e = 1; e <= 12; ++e) this.classList.remove("cols" + a[s] + "-" + e);
                ...
                a = function(t) {
                    ...
                    for (e = 0; e < n; ++e)
                        if (!a[e].classList.contains("active")) {
                            var i, s = Panda.byClass("appear-animate", a[e]);
                            for (i = s.length - 1; i >= 0; --i) s[i].classList.remove("appear-animate")
                        }
                    var o = $(t.currentTarget);
                    o.find("video").on("ended", (function() {
                        $(this).closest(".owl-item").hasClass("active") && (!0 === o.data("owl.carousel").options.autoplay ? (!1 === o.data("owl.carousel").options.loop && o.data().children - 1 === o.find(".owl-item.active").index() && (this.loop = !0, this.play()), o.trigger("next.owl.carousel"), o.trigger("play.owl.autoplay")) : (this.loop = !0, this.play()))
                    }))
                },
                n = function(t) {
                    ...
                    })), a.length && (!0 === e.data("owl.carousel").options.autoplay && e.trigger("stop.owl.autoplay"), a.each((function() {
                        this.paused && this.play()
                    })))
                },
                i = function(t) {
                    var e = this;
                    $(t.currentTarget).find(".owl-item.active .slide-animate").each((function() {
                        var t = $(this),
                        ...
                        var o = Panda.requestTimeout((function() {
                ...
                o = function(t) {
                    var e = this,
                        a = $(t.currentTarget);
                    e.translateFlag = 1, e.prev = e.next, a.find(".owl-item .slide-animate").each((function() {
                        var t = $(this),
                        ...
                        if (e.next = a.find(".owl-item").eq(t.item.index).children().attr("data-index"), a.find(".show-content").removeClass("show-content"), e.prev != e.next) {
                            ...
                            a.find(".owl-item.active .slide-animate").each((function() {
                                var t = $(this),
                                    ...
                                    i = a.delay,
                                    s = a.name;
                                t.css("animation-duration", n), t.css("animation-delay", i), t.css("transition-property", "visibility, opacity"), t.css("transition-delay", i), t.css("transition-duration", n), t.addClass(s), n = n || "0.75s", t.addClass("show-content");
                                var o = Panda.requestTimeout((function() {
            ...
            return t.min = 1, t.max = 1e6, t.value = 1, t.prototype.init = function(e) {
                    var a = this;
                    a.$minus = !1, a.$plus = !1, a.$value = !1, a.value = !1, a.startIncrease = a.startIncrease.bind(a), a.startDecrease = a.startDecrease.bind(a), a.stop = a.stop.bind(a), a.min = parseInt(e.attr("min")), a.max = parseInt(e.attr("max")), a.min || e.attr("min", a.min = t.min), a.max || e.attr("max", a.max = t.max), a.$value = e.val(a.value = t.value), a.$minus = e.prev().on("mousedown", (function(t) {
                        t.preventDefault(), a.startDecrease()
                    })).on("touchstart", (function(t) {
                        t.cancelable && t.preventDefault(), a.startDecrease()
                    })).on("mouseup", a.stop), a.$plus = e.next().on("mousedown", (function(t) {
                        t.preventDefault(), a.startIncrease()
                    })).on("touchstart", (function(t) {
                        t.cancelable && t.preventDefault(), a.startIncrease()
                    })).on("mouseup", a.stop), Panda.$body.on("mouseup", a.stop).on("touchend", a.stop).on("touchcancel", a.stop)
                }, t.prototype.startIncrease = function(t) {
                    t && t.preventDefault();
                    var e = this;
                    e.value = e.$value.val(), e.value < e.max && e.$value.val(++e.value), e.increaseTimer = Panda.requestTimeout((function() {
                        e.speed = 1, e.increaseTimer = Panda.requestInterval((function() {
                    ...
                    var t = this;
                    t.value = t.$value.val(), t.value > t.min && t.$value.val(--t.value), t.decreaseTimer = Panda.requestTimeout((function() {
                        t.speed = 1, t.decreaseTimer = Panda.requestInterval((function() {
            ...
            initMobileMenu: function() {
                ...
                })), $(".mobile-menu-overlay").on("click", t), $(".mobile-menu-close").on("click", t), Panda.$window.on("resize", t)
            },
            ...
            initCategoryMenu: function() {
                ...
                if (t.length) {
                    ...
                    if (e.length) {
                        ...
                        (window.pageYOffset > a || window.innerWidth < Panda.minDesktopWidth) && t.removeClass("show"), window.addEventListener("scroll", (function() {
                    ...
                    if (t.hasClass("with-sidebar")) {
                        ...
                        n.length && (t.find(".dropdown-box").css("width", n[0].offsetWidth - 20), Panda.$window.on("resize", (function() {
            ...
            initCollapsibleWidget: function() {
                $(".widget-collapsible .widget-title").each((function() {
                    ...
                    if (t.preventDefault(), !e.hasClass("sliding")) {
                        ...
                        e.hasClass("collapsed") || a.css("display", "block"), e.addClass("sliding"), a.slideToggle(300, (function() {
                            e.removeClass("sliding")
                        })), e.toggleClass("collapsed"), setTimeout((function() {
                            $(".sticky-sidebar").trigger("recalc.pin")
                        }), 320)
                    }
                }))
            ...
            var t, e = 0,
                ...
                o = function() {
                    if (!n)
                        for (var t = 0; t < i.length; ++t)(i[t] -= 200) <= 0 && this.close(t--)
                };
            return {
                init: function() {
                    var e = document.createElement("div");
                    e.className = "minipopup-area", Panda.byClass("page-wrapper")[0].appendChild(e), (t = $(e)).on("click", ".btn-close", (function(t) {
                        self.close($(this).closest(".minipopup-box").index())
                    })), this.close = this.close.bind(this), o = o.bind(this)
                },
                open: function(n, r) {
                    var d, l = this,
                        c = $.extend(!0, {}, Panda.defaults.minipopup, n);
                    c.isPurchased ? c.detailTemplate = Panda.parseTemplate(c.purchasedTemplate, c) : c.detailTemplate = Panda.parseTemplate(null != c.count ? c.priceQuantityTemplate : c.priceTemplate, c), null != c.rating && (c.detailTemplate += Panda.parseTemplate(c.ratingTemplate, c)), d = $(Panda.parseTemplate(c.template, c)), l.space = c.space, d.appendTo(t).css("top", -e).find("img")[0].onload = function() {
                        e += d[0].offsetHeight + l.space, d.addClass("show"), d.offset().top - window.pageYOffset < 0 && (l.close(), d.css("top", -e + d[0].offsetHeight + l.space)), d.on("mouseenter", (function() {
                            l.pause()
                            ...
                            l.resume()
                        })), a.push(d), i.push(c.delay), i.length > 1 || (s = setInterval(o, 200)), r && r(d)
                    }
                },
                close: function(t) {
                    var n = void 0 === t ? 0 : t,
                        o = a.splice(n, 1)[0];
                    void 0 !== o && (i.splice(n, 1)[0], "undefined" != i && (e -= o[0].offsetHeight + this.space, o.removeClass("show"), setTimeout((function() {
                        o.remove()
                    }), 300), a.forEach((function(t, e) {
                        e >= n && t.hasClass("show") && t.stop(!0, !0).animate({
            ...
            initProductType: function(t) {
                "slideup" === t && ($(".product-slideup-content .product-details").each((function(t) {
                    var e = $(this),
                        a = e.find(".product-hide-details").outerHeight(!0);
                    e.height(e.height() - a)
                })), $(Panda.byClass("product-slideup-content")).on("mouseenter touchstart", (function(t) {
                    var e = $(this),
                        a = e.find(".product-hide-details").outerHeight(!0);
            ...
            initSelectMenu: function() {
                Panda.$body.on("click", ".select-menu", (function(t) {
                    var e = $(this);
                    if (!e.hasClass("toolbox-sort")) {
                        var a = $(t.currentTarget),
                            ...
                            i = a.hasClass("opened"),
                            s = n.closest("li");
                        a.hasClass("fixed") ? t.stopPropagation() : 0 != e.closest(".sidebar-content").length && $(".select-menu").removeClass("opened"), a.is(n.parent()) ? (i || a.addClass("opened"), t.stopPropagation()) : (s.toggleClass("active"), s.hasClass("active") ? ($(".select-items").show(), $('<a href="#" class="select-item">' + n.text() + '<i class="p-icon-times"></i></a>').insertBefore(".select-items .filter-clean").hide().fadeIn().data("link", s)) : $(".select-items > .select-item").filter((function(t, e) {
                    ...
                    $(t.currentTarget).parent().fadeOut((function() {
                        var t = $(this),
                            e = t.data("link");
                    ...
                    a.hasClass("search-ul") || a.parent().hasClass("select-menu") || (a.hasClass("filter-price") ? (e.parent().siblings().removeClass("active"), e.parent().toggleClass("active"), t.preventDefault()) : (e.closest("li").toggleClass("active"), t.preventDefault()))
                }))
            },
            initProductsQuickview: function() {
                Panda.$body.on("click", ".btn-quickview", (function(t) {
                    ...
                    }, "quickview"), Panda.quantityInput(".quantity")
                }))
            },
            initProductsCartAction: function() {
                Panda.$body.on("click", ".off-canvas .cart-toggle", (function(t) {
                    ...
                    if (s.length > 0) e = $(".panda-compare-table > .compare-row").eq(2).children().eq(s.index()).find(".product-price .new-price, .product-price").html(), a = $(".panda-compare-table > .compare-row").eq(1).children().eq(s.index()), i.hasClass("product-single") || Panda.Minipopup.open({
                        message: "Successfully Added",
                        productClass: "product-mini",
                        name: a.find("a").text(),
                    ...
                    } else i.hasClass("product-single") || i.hasClass("product-mini"), Panda.Minipopup.open({
                        message: "Successfully Added",
                        productClass: "product-mini",
            ...
            initRemoveData: function() {
                Panda.$body.on("click", ".shop-table .product-remove .remove", (function(t) {
                    var e = $(this),
                        a = e.closest("tbody");
                    e.closest("tr").remove(), 0 == a.find("tr").length && (a.closest(".shop-table").hasClass("wishlist-table") ? document.location.href = "wishlist-empty.html" : a.closest(".shop-table").hasClass("cart-table") && (document.location.href = "cart-empty.html")), t.preventDefault()
                }))
            },
            initProductsCompareAction: function() {
                Panda.$body.on("click", ".product .btn-product-icon.btn-compare:not(.open)", (function(t) {
                    ...
                    e.hasClass("product-single") || Panda.Minipopup.open({
                    ...
                    }), $(this).addClass("open"), $(this).html('<i class="p-icon-check-solid"></i>'), $(this).attr("title", "Browse compare"), $(this).attr("href", "compare.html")
                }))
            },
            initProductsLoginAction: function() {
                Panda.$body.on("click", ".login-toggle", (function(t) {
            ...
            initProductsLoad: function() {
                $(".btn-load").on("click", (function(t) {
                    var e, a = $(this),
                        n = $(a.data("load-to")),
                        i = a.html();
                    e = "load" == a.data("load-type") ? 2 : 1, a.text("Loading ..."), a.addClass("btn-loading"), $(".loading").css("display", "block"), t.preventDefault(), $.ajax({
                        url: a.attr("href"),
                        success: function(t) {
                            var s = $(t);
                            setTimeout((function() {
            ...
            initProductsScrollLoad: function(t) {
                ...
                var i = function(t) {
                    window.pageYOffset > e + a.outerHeight() - window.innerHeight - 150 && "loading" != a.data("load-state") && $.ajax({
                        url: n,
                        success: function(t) {
                            var e = $(t);
                            a.data("load-state", "loading"), a.next().hasClass("load-more-overlay") ? a.next().addClass("loading") : $('<div class="mt-4 mb-4 load-more-overlay loading"></div>').insertAfter(a), setTimeout((function() {
                                a.next().removeClass("loading"), a.append(e), setTimeout((function() {
                                    a.find(".product-wrap.fade:not(.in)").addClass("in")
                                }), 200), a.data("load-state", "loaded")
                            }), 500);
                            var n = parseInt(a.data("load-count") ? a.data("load-count") : 0);
                            a.data("load-count", ++n), n > 2 && window.removeEventListener("scroll", i, {
                                passive: !0
                            })
                        },
                        failure: function() {
                ...
                a.length > 0 && (e = a.offset().top, window.addEventListener("scroll", i, {
                    passive: !0
                }))
            },
            initWishlistButton: function(t) {
                Panda.$body.on("click", t, (function(t) {
                    var e = $(this);
                    e.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function() {
                        e.removeClass("load-more-overlay loading").find("i").toggleClass("p-icon-heart-solid").toggleClass("p-icon-heart-fill"), e.hasClass("added") ? e.attr("title", "Remove from wishlist") : e.attr("title", "Add to wishlist")
                    }), 500), t.preventDefault()
                }))
            }
        }, Panda.prepare = function() {
            Panda.$body.hasClass("with-flex-container") && window.innerWidth >= 1200 && Panda.$body.addClass("sidebar-active"), $(document).ready((function() {
            ...
            Panda.appearAnimate(".appear-animate"), Panda.Minipopup.init(), Panda.Shop.init(), Panda.initProductSinglePage(), Panda.slider(".owl-carousel"), Panda.headerToggleSearch(".hs-toggle"), Panda.stickyContent(".sticky-header", {
                top: !1
            }), Panda.stickyContent(".sticky-footer", Panda.defaults.stickyFooter), Panda.stickyContent(".sticky-toolbox", Panda.defaults.stickyToolbox), Panda.sidebar("sidebar"), Panda.sidebar("right-sidebar"), Panda.quantityInput(".quantity"), Panda.playableVideo(".inner-video"), Panda.initAccordion(".card-header > a"), Panda.initTab(".nav-tabs"), Panda.initAlert(".alert"), Panda.parallax(".parallax"), Panda.countTo(".count-to"), Panda.countdown(".product-countdown, .countdown"), Panda.Menu.init(), Panda.initZoom(), Panda.initPopups(), Panda.initPurchasedMinipopup(), Panda.initScrollTopButton(), Panda.initFloatingElements(".floating"), Panda.initAdvancedMotions(".skrollr"), Panda.hashScroll.init(), Panda.orderView(), Panda.ibNavSurfer(), Panda.status = "complete"
        }, Panda.prepare(), window.onload = function() {
