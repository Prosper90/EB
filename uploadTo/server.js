...
app.use(session({
  ...
  store: MongoStore.create({mongoUrl: "mongodb://localhost:27017/EB" }),
...
app.get("/",  async function(req, res){
  ...
  console.log(res.locals.messages, req.session.locals, "checking other details one");
  res.render("homemain", {sideProducts: sideProducts, user: req.user, cartProducts: seletproduct,  });
});
